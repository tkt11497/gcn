...
export default async function (req, res, next) {
    ...
    await axios.get(hit_url).then(async (response)=>{
       ...
       responseData.team_1_player_1_rune=a['rune_path_1']+Object.keys(team_1_players[0].rune_map)[Object.keys(team_1_players[0].rune_map).length-1]+'.png'
       responseData.team_1_player_2_rune=a['rune_path_1']+Object.keys(team_1_players[1].rune_map)[Object.keys(team_1_players[1].rune_map).length-1]+'.png'
       responseData.team_1_player_3_rune=a['rune_path_1']+Object.keys(team_1_players[2].rune_map)[Object.keys(team_1_players[2].rune_map).length-1]+'.png'
       responseData.team_1_player_4_rune=a['rune_path_1']+Object.keys(team_1_players[3].rune_map)[Object.keys(team_1_players[3].rune_map).length-1]+'.png'
       responseData.team_1_player_5_rune=a['rune_path_1']+Object.keys(team_1_players[4].rune_map)[Object.keys(team_1_players[4].rune_map).length-1]+'.png'
       //team 1 roles
       ...
       responseData.team_1_player_1_item_1=a['item_png_path_1']+(team_1_players[0].equip_list[0]||0)+'.png'
       responseData.team_1_player_1_item_2=a['item_png_path_1']+(team_1_players[0].equip_list[1]||0)+'.png'
       responseData.team_1_player_1_item_3=a['item_png_path_1']+(team_1_players[0].equip_list[2]||0)+'.png'
       responseData.team_1_player_1_item_4=a['item_png_path_1']+(team_1_players[0].equip_list[3]||0)+'.png'
       responseData.team_1_player_1_item_5=a['item_png_path_1']+(team_1_players[0].equip_list[4]||0)+'.png'
       responseData.team_1_player_1_item_6=a['item_png_path_1']+(team_1_players[0].equip_list[5]||0)+'.png'

       responseData.team_1_player_2_item_1=a['item_png_path_1']+(team_1_players[1].equip_list[0]||0)+'.png'
       responseData.team_1_player_2_item_2=a['item_png_path_1']+(team_1_players[1].equip_list[1]||0)+'.png'
       responseData.team_1_player_2_item_3=a['item_png_path_1']+(team_1_players[1].equip_list[2]||0)+'.png'
       responseData.team_1_player_2_item_4=a['item_png_path_1']+(team_1_players[1].equip_list[3]||0)+'.png'
       responseData.team_1_player_2_item_5=a['item_png_path_1']+(team_1_players[1].equip_list[4]||0)+'.png'
       responseData.team_1_player_2_item_6=a['item_png_path_1']+(team_1_players[1].equip_list[5]||0)+'.png'

       responseData.team_1_player_3_item_1=a['item_png_path_1']+(team_1_players[2].equip_list[0]||0)+'.png'
       responseData.team_1_player_3_item_2=a['item_png_path_1']+(team_1_players[2].equip_list[1]||0)+'.png'
       responseData.team_1_player_3_item_3=a['item_png_path_1']+(team_1_players[2].equip_list[2]||0)+'.png'
       responseData.team_1_player_3_item_4=a['item_png_path_1']+(team_1_players[2].equip_list[3]||0)+'.png'
       responseData.team_1_player_3_item_5=a['item_png_path_1']+(team_1_players[2].equip_list[4]||0)+'.png'
       responseData.team_1_player_3_item_6=a['item_png_path_1']+(team_1_players[2].equip_list[5]||0)+'.png'

       responseData.team_1_player_4_item_1=a['item_png_path_1']+(team_1_players[3].equip_list[0]||0)+'.png'
       responseData.team_1_player_4_item_2=a['item_png_path_1']+(team_1_players[3].equip_list[1]||0)+'.png'
       responseData.team_1_player_4_item_3=a['item_png_path_1']+(team_1_players[3].equip_list[2]||0)+'.png'
       responseData.team_1_player_4_item_4=a['item_png_path_1']+(team_1_players[3].equip_list[3]||0)+'.png'
       responseData.team_1_player_4_item_5=a['item_png_path_1']+(team_1_players[3].equip_list[4]||0)+'.png'
       responseData.team_1_player_4_item_6=a['item_png_path_1']+(team_1_players[3].equip_list[5]||0)+'.png'

       responseData.team_1_player_5_item_1=a['item_png_path_1']+(team_1_players[4].equip_list[0]||0)+'.png'
       responseData.team_1_player_5_item_2=a['item_png_path_1']+(team_1_players[4].equip_list[1]||0)+'.png'
       responseData.team_1_player_5_item_3=a['item_png_path_1']+(team_1_players[4].equip_list[2]||0)+'.png'
       responseData.team_1_player_5_item_4=a['item_png_path_1']+(team_1_players[4].equip_list[3]||0)+'.png'
       responseData.team_1_player_5_item_5=a['item_png_path_1']+(team_1_players[4].equip_list[4]||0)+'.png'
       responseData.team_1_player_5_item_6=a['item_png_path_1']+(team_1_players[4].equip_list[5]||0)+'.png'
      ...
      responseData.team_2_player_1_rune=a['rune_path_1']+Object.keys(team_2_players[0].rune_map)[Object.keys(team_2_players[0].rune_map).length-1]+'.png'
      responseData.team_2_player_2_rune=a['rune_path_1']+Object.keys(team_2_players[1].rune_map)[Object.keys(team_2_players[1].rune_map).length-1]+'.png'
      responseData.team_2_player_3_rune=a['rune_path_1']+Object.keys(team_2_players[2].rune_map)[Object.keys(team_2_players[2].rune_map).length-1]+'.png'
      responseData.team_2_player_4_rune=a['rune_path_1']+Object.keys(team_2_players[3].rune_map)[Object.keys(team_2_players[3].rune_map).length-1]+'.png'
      responseData.team_2_player_5_rune=a['rune_path_1']+Object.keys(team_2_players[4].rune_map)[Object.keys(team_2_players[4].rune_map).length-1]+'.png'
      //team 2 roles
      ...
      responseData.team_2_player_1_item_1=a['item_png_path_1']+(team_2_players[0].equip_list[0]||0)+'.png'
      responseData.team_2_player_1_item_2=a['item_png_path_1']+(team_2_players[0].equip_list[1]||0)+'.png'
      responseData.team_2_player_1_item_3=a['item_png_path_1']+(team_2_players[0].equip_list[2]||0)+'.png'
      responseData.team_2_player_1_item_4=a['item_png_path_1']+(team_2_players[0].equip_list[3]||0)+'.png'
      responseData.team_2_player_1_item_5=a['item_png_path_1']+(team_2_players[0].equip_list[4]||0)+'.png'
      responseData.team_2_player_1_item_6=a['item_png_path_1']+(team_2_players[0].equip_list[5]||0)+'.png'

      responseData.team_2_player_2_item_1=a['item_png_path_1']+(team_2_players[1].equip_list[0]||0)+'.png'
      responseData.team_2_player_2_item_2=a['item_png_path_1']+(team_2_players[1].equip_list[1]||0)+'.png'
      responseData.team_2_player_2_item_3=a['item_png_path_1']+(team_2_players[1].equip_list[2]||0)+'.png'
      responseData.team_2_player_2_item_4=a['item_png_path_1']+(team_2_players[1].equip_list[3]||0)+'.png'
      responseData.team_2_player_2_item_5=a['item_png_path_1']+(team_2_players[1].equip_list[4]||0)+'.png'
      responseData.team_2_player_2_item_6=a['item_png_path_1']+(team_2_players[1].equip_list[5]||0)+'.png'

      responseData.team_2_player_3_item_1=a['item_png_path_1']+(team_2_players[2].equip_list[0]||0)+'.png'
      responseData.team_2_player_3_item_2=a['item_png_path_1']+(team_2_players[2].equip_list[1]||0)+'.png'
      responseData.team_2_player_3_item_3=a['item_png_path_1']+(team_2_players[2].equip_list[2]||0)+'.png'
      responseData.team_2_player_3_item_4=a['item_png_path_1']+(team_2_players[2].equip_list[3]||0)+'.png'
      responseData.team_2_player_3_item_5=a['item_png_path_1']+(team_2_players[2].equip_list[4]||0)+'.png'
      responseData.team_2_player_3_item_6=a['item_png_path_1']+(team_2_players[2].equip_list[5]||0)+'.png'

      responseData.team_2_player_4_item_1=a['item_png_path_1']+(team_2_players[3].equip_list[0]||0)+'.png'
      responseData.team_2_player_4_item_2=a['item_png_path_1']+(team_2_players[3].equip_list[1]||0)+'.png'
      responseData.team_2_player_4_item_3=a['item_png_path_1']+(team_2_players[3].equip_list[2]||0)+'.png'
      responseData.team_2_player_4_item_4=a['item_png_path_1']+(team_2_players[3].equip_list[3]||0)+'.png'
      responseData.team_2_player_4_item_5=a['item_png_path_1']+(team_2_players[3].equip_list[4]||0)+'.png'
      responseData.team_2_player_4_item_6=a['item_png_path_1']+(team_2_players[3].equip_list[5]||0)+'.png'

      responseData.team_2_player_5_item_1=a['item_png_path_1']+(team_2_players[4].equip_list[0]||0)+'.png'
      responseData.team_2_player_5_item_2=a['item_png_path_1']+(team_2_players[4].equip_list[1]||0)+'.png'
      responseData.team_2_player_5_item_3=a['item_png_path_1']+(team_2_players[4].equip_list[2]||0)+'.png'
      responseData.team_2_player_5_item_4=a['item_png_path_1']+(team_2_players[4].equip_list[3]||0)+'.png'
      responseData.team_2_player_5_item_5=a['item_png_path_1']+(team_2_players[4].equip_list[4]||0)+'.png'
      responseData.team_2_player_5_item_6=a['item_png_path_1']+(team_2_players[4].equip_list[5]||0)+'.png'
